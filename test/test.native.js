...
tape( 'if provided a number outside `[0,1]` for `p` and a valid `lambda`, the function returns `NaN`', opts, function test( t ) {
...
tape( 'if provided `1.0` for `p` and a valid `lambda`, the function returns `+Infinity`', opts, function test( t ) {
